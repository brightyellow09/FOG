...
class TabularPolicy(Policy):
    def __init__(self, game):
        ...
        histories = game.get_all_histories(game) #!!!
            ...
            for _, history in histories:
                ...
                if len(legal_actions):
                    ...
                    if key not in self.history_lookup:
                        history_index = len(legal_actions_list):
    ...
    def policy_for_key(self, key):
        ...
        return self.action_probability_table[policy_index]

    def action_probabilities(self, history, player_id):
        policy_index = self.history_lookup[self._history_key(history,history[-1].next_state.current_player())]
        policy = self.action_probability_table[policy_index]
    ...
    def __copy__(self):
        ...
        result.action_probabilities_table = self.action_probability_table
